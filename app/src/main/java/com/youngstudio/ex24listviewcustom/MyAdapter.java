package com.youngstudio.ex24listviewcustom;
...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        //xml로 View모양을 설계하고 이를 객체로 만들어서 리턴함.

        //listview_item.xml문서를 읽어와서
        //View객체로 만들어주는(부풀리다 inflate) 객체를 이용하여 View객체 생성
        ...
        //현재번째(position) View에 보여줄 데이터를 얻어오기
